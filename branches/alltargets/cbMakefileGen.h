 ...
 * Author:    KiSoft (kisoft@rambler.ru)
 * Created:   2007-06-08
 * Copyright: KiSoft
 * License:   GPL
 **************************************************************/

#ifndef CBMAKEFILEGEN_H_INCLUDED
#define CBMAKEFILEGEN_H_INCLUDED
...
class cbMakefileGen : public cbPlugin
{
public:
    /** Constructor. */
    cbMakefileGen();
    /** Destructor. */
    virtual ~cbMakefileGen();
...
#endif // CBMAKEFILEGEN_H_INCLUDED
